...
var apiWare=function(connectionString,connectionOptions,mainCallback)
{
    var kwaaiCrudware=require('kwaai-crudware').crudWare(connectionString,connectionOptions,mainCallback);
...
module.exports=function(connectionString,connectionOptions,callback){
    return new apiWare(connectionString,connectionOptions,callback);
}
